import pandas as pd
from Utils import plot_portfolio_value
from Backtest import backtestN
from Backtest import backtestP
import optuna
...
if __name__ == '__main__':
    ...
    for combo in all_combinations:
        ...
        study.optimize(lambda trial: optimize(trial, combo, data),n_trials=1)


data1= pd.read_csv("/Users/edson33/Desktop/DecimoSemestre/btc_project_test.csv").dropna()
#data1= data[:10000]
value = backtestP(['RSI', 'MACD', 'SMA'],data1,
    sl=0.042,
    tp=0.034,
    rsi_window=14,
    rsi_lower=30,
...
plot_portfolio_value(value,data1)